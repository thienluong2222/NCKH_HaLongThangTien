...
CONSTRAINTS_DB = {
    ...
    "Sân Khấu Dù Kê": [
        ...
        ("is_on", ["Nguoi bieu dien", "Giap nguc dinh hat"], False, 0.6, None),
        ("is_on", ["Nguoi bieu dien", "Tay ao dinh hat"], False, 0.6, None),
        ("is_on", ["Nguoi bieu dien", "Toc bui cao"], False, 0.6, None),
        ("is_on", ["Nguoi bieu dien", "Deo vong tay"], False, 0.6, None),
        ("is_on", ["Nguoi bieu dien", "Dau doi khan dong"], False, 0.6, None),
        ("is_on", ["Nguoi bieu dien", "Ao ren dinh hat"], False, 0.6, None),
        ("is_on", ["Nguoi bieu dien", "Vay sampot"], False, 0.6, None),
        ("is_on", ["Nguoi bieu dien", "That lung ban to"], False, 0.6, None),
        ("is_on", ["Nguoi bieu dien", "Deo vong co"], False, 0.6, None),
        ("is_on", ["Nguoi bieu dien", "Do vai bong"], False, 0.6, None),
        ("is_on", ["Nguoi bieu dien", "Giap than duoi"], False, 0.6, None),
